...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`sticky top-0 z-50 w-full border-b border-neutral-800 bg-black/95 px-4 py-4 backdrop-blur transition-transform duration-300 sm:px-6 ${
      ...
      >
        <div className="mx-auto flex max-w-5xl items-center justify-between">
          <Link href="/feed" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-white">Sociality</span>
          </Link>
      ...
      {searchOpen && (
        <>
          ...
          <div className="fixed inset-x-0 top-[72px] z-50 px-4 sm:px-6">
            <div
              ref={searchPanelRef}
